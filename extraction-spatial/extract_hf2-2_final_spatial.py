...
def getdata(filename, skywindows, nebularwindows, outputdir="python/final/Hf2-2/spatial/"):
...
for x in (300,312,324,336,348,360,372,384,396,408):
    nebularwindows=(x,x+11)
