...
def getdata(filename, skywindows, nebularwindows, outputdir="python/final/Fg1/spatial/"):
...
# Fg1
# something is weirdly fucked with the files. red and blue appear at different positions on the frame, but despite same crval2 and crpix2, seem to need the same nebular windows.
# original nebular windows: 100,252,264,418
# divide into 6 spatial bins
skywindows=(630,800,801,900)
skywindows=(6,30,700,1000)
for x in (40,60,80,100,126,146,166,186):
    nebularwindows=(x,x+19)
    getdata("Fg1Blue_clean.fits",skywindows,nebularwindows)

for x in (176,196,216,236,262,282,302,322):
    nebularwindows=(x,x+19)
